...
public class PromoCodesController : ControllerBase
{
    ...
    public async Task<IActionResult> UpdatePromoCode(int id, UpdatePromoCodeDto dto)
    {
        ...
        // Note: Expiration date update was not explicitly requested, sticking to basic updates.
        // If user wants to extend validity, they can delete and recreate or we add it later.
